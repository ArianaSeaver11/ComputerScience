...
def first_aisle():      #start finding the flower
...
def finding_baking_soda():      #finding baking soda
...
def strange_sound():        #might be a karen attack
...
def finding_the_butter():           #collecting butter
...
def enter_office():
    print("You honeslty don't know why you came this way, you turn back and go to the dairy department.")
    enter_dairy()
...
def weird_creature():       #it's Gale Luis, either you get it or you don't
...
def poultry_section():          # finding the eggs
...
def check_out():            # buying the ingredients
...
def enter_checkout_line():
    print("What kind of psycho doesnt go to self checkout, go back…")
    check_out()
